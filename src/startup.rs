...
async fn run(
    ...
    let hmac_key = Key::from(hmac_secret.expose_secret().as_bytes());
    let message_store = CookieMessageStore::builder(hmac_key.clone()).build();
        ...
        App::new()
            ...
            .service(
                web::scope("/admin")
                    ...
                    .route("/newsletter", web::get().to(routes::newsletter_form))
                    .route("/newsletter", web::post().to(routes::newsletter))
